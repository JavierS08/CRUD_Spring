package com.example.hi_javier.seguridad;
...
// Recursos estáticos que no requieren autentificación.
                ...
                // Solo puede acceder a la vista clientes el usuario con rol ADMINISTRADOR
                .requestMatchers("/admin/**").hasAuthority("ADMINISTRADOR")
                // Solo puede acceder el usuario con rol USUARIO
